...
public:
	//Sound in db is as heard from one meter away
	...
	FRotator Rotation, FName DetectionTag, float VolumeMultiplier = 1, const float DetectionVolumeDb = 80, float PitchMultiplier = 1, float StartTime = 0, 
